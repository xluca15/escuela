...
class ConnectionManager
{
	...
	{
		return $this->byId( "fixture_at_localhost" );
	}
	...
	protected function _setConnectionsData()
	{
		...
		$data = array();
		$data["dbType"] = 0;
		$data["connId"] = "fixture_at_localhost";
		$data["connName"] = "fixture at localhost";
		$data["connStringType"] = "mysql";
		$data["connectionString"] = "mysql;localhost;root;;;fixture;;1"; //currently unused

		$this->_connectionsIdByName["fixture at localhost"] = "fixture_at_localhost";
		...
		$data["connInfo"][2] = "";
		$data["connInfo"][3] = "";
		$data["connInfo"][4] = "fixture";
		$data["connInfo"][5] = ""; //currently unused
		$data["connInfo"][6] = "1"; //currently unused
		$data["ODBCString"] = "DRIVER={MySQL ODBC 3.51 Driver};Server=localhost;Uid=root;Pwd=;Database=fixture;OPTION=3";
		// encription set
		...
		$connectionsData["fixture_at_localhost"] = $data;
	...
	{
		$connectionsIds = array();
		$connectionsIds["cambios"] = "fixture_at_localhost";
		$connectionsIds["colores"] = "fixture_at_localhost";
		$connectionsIds["dts"] = "fixture_at_localhost";
		$connectionsIds["estadios"] = "fixture_at_localhost";
		$connectionsIds["goles"] = "fixture_at_localhost";
		$connectionsIds["partidos"] = "fixture_at_localhost";
		$connectionsIds["jugadores"] = "fixture_at_localhost";
		$connectionsIds["posicion"] = "fixture_at_localhost";
		$connectionsIds["selecciones"] = "fixture_at_localhost";
		$connectionsIds["tipodegol"] = "fixture_at_localhost";
