...
function fillProjectEntites()
{
	...
	if( count( $projectEntities ) )
		return;
	$projectEntities[ "cambios" ] = array( "url" => "cambios", "type" => 0 );
	$projectEntitiesReverse[ "cambios" ] = "cambios";
	$projectEntities[ "colores" ] = array( "url" => "colores", "type" => 0 );
	$projectEntitiesReverse[ "colores" ] = "colores";
	$projectEntities[ "dts" ] = array( "url" => "dts", "type" => 0 );
	$projectEntitiesReverse[ "dts" ] = "dts";
	$projectEntities[ "estadios" ] = array( "url" => "estadios", "type" => 0 );
	$projectEntitiesReverse[ "estadios" ] = "estadios";
	$projectEntities[ "goles" ] = array( "url" => "goles", "type" => 0 );
	$projectEntitiesReverse[ "goles" ] = "goles";
	$projectEntities[ "partidos" ] = array( "url" => "partidos", "type" => 0 );
	$projectEntitiesReverse[ "partidos" ] = "partidos";
	$projectEntities[ "jugadores" ] = array( "url" => "jugadores", "type" => 0 );
	$projectEntitiesReverse[ "jugadores" ] = "jugadores";
	$projectEntities[ "posicion" ] = array( "url" => "posicion", "type" => 0 );
	$projectEntitiesReverse[ "posicion" ] = "posicion";
	$projectEntities[ "selecciones" ] = array( "url" => "selecciones", "type" => 0 );
	$projectEntitiesReverse[ "selecciones" ] = "selecciones";
	$projectEntities[ "tipodegol" ] = array( "url" => "tipodegol", "type" => 0 );
	$projectEntitiesReverse[ "tipodegol" ] = "tipodegol";
}
