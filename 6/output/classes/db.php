...
class DB
{
	...
	protected static function _fillTablesList()
	{
		...
		if( "fixture_at_localhost" == $conn->connId )
		{
			$dalTables[$conn->connId][] = array("name" => "cambios", "varname" => "fixture_at_localhost__cambios", "altvarname" => "cambios", "connId" => "fixture_at_localhost", "schema" => "", "connName" => "fixture at localhost");
			$dalTables[$conn->connId][] = array("name" => "colores", "varname" => "fixture_at_localhost__colores", "altvarname" => "colores", "connId" => "fixture_at_localhost", "schema" => "", "connName" => "fixture at localhost");
			$dalTables[$conn->connId][] = array("name" => "dts", "varname" => "fixture_at_localhost__dts", "altvarname" => "dts", "connId" => "fixture_at_localhost", "schema" => "", "connName" => "fixture at localhost");
			$dalTables[$conn->connId][] = array("name" => "estadios", "varname" => "fixture_at_localhost__estadios", "altvarname" => "estadios", "connId" => "fixture_at_localhost", "schema" => "", "connName" => "fixture at localhost");
			$dalTables[$conn->connId][] = array("name" => "goles", "varname" => "fixture_at_localhost__goles", "altvarname" => "goles", "connId" => "fixture_at_localhost", "schema" => "", "connName" => "fixture at localhost");
			$dalTables[$conn->connId][] = array("name" => "jugadores", "varname" => "fixture_at_localhost__jugadores", "altvarname" => "jugadores", "connId" => "fixture_at_localhost", "schema" => "", "connName" => "fixture at localhost");
			$dalTables[$conn->connId][] = array("name" => "partidos", "varname" => "fixture_at_localhost__partidos", "altvarname" => "partidos", "connId" => "fixture_at_localhost", "schema" => "", "connName" => "fixture at localhost");
			$dalTables[$conn->connId][] = array("name" => "posicion", "varname" => "fixture_at_localhost__posicion", "altvarname" => "posicion", "connId" => "fixture_at_localhost", "schema" => "", "connName" => "fixture at localhost");
			$dalTables[$conn->connId][] = array("name" => "selecciones", "varname" => "fixture_at_localhost__selecciones", "altvarname" => "selecciones", "connId" => "fixture_at_localhost", "schema" => "", "connName" => "fixture at localhost");
			$dalTables[$conn->connId][] = array("name" => "tipodegol", "varname" => "fixture_at_localhost__tipodegol", "altvarname" => "tipodegol", "connId" => "fixture_at_localhost", "schema" => "", "connName" => "fixture at localhost");
		}
	}
