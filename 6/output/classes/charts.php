...
class Chart
{
	...
	protected function isProjectDB()
	{
		...
		if("cambios" == $this->chrt_array['tables'][0])
			return true;
		if("colores" == $this->chrt_array['tables'][0])
			return true;
		if("dts" == $this->chrt_array['tables'][0])
			return true;
		if("estadios" == $this->chrt_array['tables'][0])
			return true;
		if("goles" == $this->chrt_array['tables'][0])
			return true;
		if("partidos" == $this->chrt_array['tables'][0])
			return true;
		if("jugadores" == $this->chrt_array['tables'][0])
			return true;
		if("posicion" == $this->chrt_array['tables'][0])
			return true;
		if("selecciones" == $this->chrt_array['tables'][0])
			return true;
		if("tipodegol" == $this->chrt_array['tables'][0])
			return true;
		return false;
	}
