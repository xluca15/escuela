...
class tDAL
{
	var $tblfixture_at_localhost__cambios;
	var $tblfixture_at_localhost__colores;
	var $tblfixture_at_localhost__dts;
	var $tblfixture_at_localhost__estadios;
	var $tblfixture_at_localhost__goles;
	var $tblfixture_at_localhost__jugadores;
	var $tblfixture_at_localhost__partidos;
	var $tblfixture_at_localhost__posicion;
	var $tblfixture_at_localhost__selecciones;
	var $tblfixture_at_localhost__tipodegol;
	var $lstTables;
	var $Table = array();
	...
	function FillTablesList()
	{
		if($this->lstTables)
			return;
		$this->lstTables[] = array("name" => "cambios", "varname" => "fixture_at_localhost__cambios", "altvarname" => "cambios", "connId" => "fixture_at_localhost", "schema" => "", "connName" => "fixture at localhost");
		$this->lstTables[] = array("name" => "colores", "varname" => "fixture_at_localhost__colores", "altvarname" => "colores", "connId" => "fixture_at_localhost", "schema" => "", "connName" => "fixture at localhost");
		$this->lstTables[] = array("name" => "dts", "varname" => "fixture_at_localhost__dts", "altvarname" => "dts", "connId" => "fixture_at_localhost", "schema" => "", "connName" => "fixture at localhost");
		$this->lstTables[] = array("name" => "estadios", "varname" => "fixture_at_localhost__estadios", "altvarname" => "estadios", "connId" => "fixture_at_localhost", "schema" => "", "connName" => "fixture at localhost");
		$this->lstTables[] = array("name" => "goles", "varname" => "fixture_at_localhost__goles", "altvarname" => "goles", "connId" => "fixture_at_localhost", "schema" => "", "connName" => "fixture at localhost");
		$this->lstTables[] = array("name" => "jugadores", "varname" => "fixture_at_localhost__jugadores", "altvarname" => "jugadores", "connId" => "fixture_at_localhost", "schema" => "", "connName" => "fixture at localhost");
		$this->lstTables[] = array("name" => "partidos", "varname" => "fixture_at_localhost__partidos", "altvarname" => "partidos", "connId" => "fixture_at_localhost", "schema" => "", "connName" => "fixture at localhost");
		$this->lstTables[] = array("name" => "posicion", "varname" => "fixture_at_localhost__posicion", "altvarname" => "posicion", "connId" => "fixture_at_localhost", "schema" => "", "connName" => "fixture at localhost");
		$this->lstTables[] = array("name" => "selecciones", "varname" => "fixture_at_localhost__selecciones", "altvarname" => "selecciones", "connId" => "fixture_at_localhost", "schema" => "", "connName" => "fixture at localhost");
		$this->lstTables[] = array("name" => "tipodegol", "varname" => "fixture_at_localhost__tipodegol", "altvarname" => "tipodegol", "connId" => "fixture_at_localhost", "schema" => "", "connName" => "fixture at localhost");
	}
